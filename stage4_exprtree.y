...
%token NUM PLUS MINUS MUL DIV ID READ WRITE BEGIN1 END NEWLINE EQUALSTO IF then ENDIF Else WHILE ENDWHILE DO EQ NE LT GT LE GE DECL ENDDECL INT STR COMMA MOD 
%left PLUS MINUS
%left '*' DIV MOD 
%left LT GT LE GE 
%left EQ NE
...
E         : E PLUS E        	{$$ = createTree(0,-1,NULL,3,$1,$3,NULL);}
	  ...
	  | E '*' E            	{$$ = createTree(0,-1,NULL,5,$1,$3,NULL);}
          | E MOD E             {$$=createTree(0,-1,NULL,24,$1,$3,NULL);}
